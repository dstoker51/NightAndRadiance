...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        scene.lightSources.append(LightSource(worldPosition: Point(0.0, 10.0, -2.0), color: Color(red: 255, green: 255, blue: 255)))
        ...
        let ppm = PPMWriter(filename: "output.ppm", filepath: "/Users/dstoker/Library/Containers/dstoker51.NightAndRadiance/Data/Documents/", width: Int(width), height: Int(height))
