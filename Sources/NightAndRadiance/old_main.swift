...
//import Foundation
//
//func rayColor(ray: Ray, world: Strikeable, depth: Int) -> Color {
...
//        let target = record.point + record.normal + Vector.randomInUnitSphere()
...
//
//// World
//var world: Strikeables = .init()
//world.add(strikeableObject: Sphere(center: Point(0.0, 0.0, -1.0), radius: 0.5))
//world.add(strikeableObject: Sphere(center: Point(0.0, -100.5, -1.0), radius: 100.0))
//
//// Camera
//let camera = Camera()
//
